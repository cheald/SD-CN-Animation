...
def inputs_ui():
    ...
    with gr.Tabs():
        ...
        with gr.Tab('vid2vid') as tab_vid2vid:
            ...
            with gr.Row():
                v2v_mask_prompt = gr.Textbox(label='Mask prompt', lines=1, interactive=True, elem_id=f"vid2vid_mask_prompt", placeholder="Enter your prompt here...")
                v2v_mask_negative_prompt = gr.Textbox(label='Mask negative prompt', lines=1, interactive=True, elem_id=f"vid2vid_mask_neg_prompt", placeholder="Enter your prompt here...")
            ...
            with gr.Row():
                v2v_frame_skip = gr.Slider(label="Frame skip", minimum=1, maximum=24, step=1)
